...
<h3 align="center">
  <img src="public/images/terra-logo-1.png" height="20" style="vertical-align: text-bottom;" /> Terra 能源管理系统 — 基于 React + Ant Design 的企业级前端
</h3>
...
Terra EMS Web 是 Terra 能源管理系统的前端应用，基于 **Ant Design Pro** 与 **UmiJS 4** 构建。它不仅提供了一套开箱即用的工业级管理界面，还特别针对 **物联网（IoT）场景** 进行了优化，支持通过 **YAML 场站配置一键部署** 整个工厂结构，并提供实时的能效看板、分时价费分析、碳足迹追踪及多维度的报警监控功能。
...
> [!TIP]
> **前端黑科技：零代码初始化**：
> 配合后端的“代码导向（Code-as-Config）”方案，前端现已支持全站配置 YAML 导入。实施工程师无需在页面上繁琐点选，直接拖入配置文件即可瞬间生成百万级数据的层级底座。
